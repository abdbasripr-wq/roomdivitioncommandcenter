    ...
    <ProtectRoute requiredRoles={[USER_ROLES.ADMIN, USER_ROLES.HK]}>
      <AppShell>
        <div className="space-y-8">
          <div>
            <h1 className="text-4xl font-bold text-foreground">Guest Laundry</h1>
            <p className="text-muted-foreground mt-2">Upload and manage guest laundry service records</p>
          </div>
          <UploadContainer module="housekeeping" reportType="guest-laundry" />
        </div>
      </AppShell>
    </ProtectRoute>
  );
